...
import (
	...
	"github.com/kube-agent/kuery/pkg/generated/clientset/versioned/scheme"
)
...
// CoreV1alpha1Client is used to interact with features provided by the core.kuery.io group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) KueryFlows(namespace string) KueryFlowInterface {
	return newKueryFlows(c, namespace)
}
