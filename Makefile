...
DOCKER_REGISTRY ?= ghcr.io/kube-agent/kuery
...
KUERY_CONTROLLER_MANAGER_VERBOSITY ?= 2
...
$(CONTROLLER_GEN): $(LOCALBIN)
	...
	GOTOOLCHAIN=go1.23.4 GOBIN=$(LOCALBIN) go install sigs.k8s.io/controller-tools/cmd/controller-gen@$(CONTROLLER_TOOLS_VERSION)
